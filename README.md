...
<script type="text/javascript">
libdoc = {"specversion": 1, "name": "SwagLabsLibrary", "doc": "<p>SwagLabsLibrary is a demo library that provides keywords to automateinteraction with the Swag Labs demo application (<a href=\"https://www.saucedemo.com/v1/index.html\">https://www.saucedemo.com/v1/index.html</a>). This library demonstrate the basic usage of <span class=\"name\">PythonLibCore</span> (<a href=\"https://github.com/robotframework/PythonLibCore\">https://github.com/robotframework/PythonLibCore</a>) for creating custom Robot Framework library that suites your application. To learn more about robot framework, visit the following websites:</p>\n<ul>\n<li><a href=\"https://robotframework.org/\">https://robotframework.org/</a></li>\n<li><a href=\"https://robotframework.org/robotframework/latest/RobotFrameworkUserGuide.html\">https://robotframework.org/robotframework/latest/RobotFrameworkUserGuide.html</a></li>\n</ul>\n<p>NOTE: This is for demo purposes only! The construction of the keywords and the codes may be different in real projects and may be a little more complicated.</p>", "version": "", "generated": "2023-06-19T00:10:48+00:00", "type": "LIBRARY", "scope": "GLOBAL", "docFormat": "HTML", "source": "C:\\Users\\WONDERS\\Projects\\vscode\\portfolio-robotframework-custom-lib\\SwagLabsLibrary\\__init__.py", "lineno": 11, "tags": ["AssertionKeywords", "BrowserKeywords", "LoginKeywords", "ProductsKeywords"], "inits": [{"name": "__init__", "args": [{"name": "is_headless", "types": ["bool"], "typedocs": {"bool": "boolean"}, "defaultValue": "True", "kind": "POSITIONAL_OR_NAMED", "required": false, "repr": "is_headless: bool = True"}, {"name": "env", "types": ["str"], "typedocs": {"str": "string"}, "defaultValue": "prod", "kind": "POSITIONAL_OR_NAMED", "required": false, "repr": "env: str = prod"}], "doc": "<p>Configuration whether to open browser in headless mode and on which environment to execute can be passed when importing the library.</p>\n<p>Arguments:</p>\n<ul>\n<li><code>is_headless</code>: Whether to run the browser in headless mode. Defaults to <code>True</code>.</li>\n<li><code>env</code>: Will be used to identify which url will be used when opening the application in the browser.</li>\n</ul>\n<p>Example:</p>\n<table border=\"1\">\n<tr>\n<td>Library</td>\n<td>SwagLabsLibrary</td>\n<td>is_headless=${False}</td>\n</tr>\n</table>", "shortdoc": "Configuration whether to open browser in headless mode and on which environment to execute can be passed when importing the library.", "tags": [], "source": "C:\\Users\\WONDERS\\Projects\\vscode\\portfolio-robotframework-custom-lib\\SwagLabsLibrary\\__init__.py", "lineno": 20}], "keywords": [{"name": "Close All Swaglabs Browser", "args": [], "doc": "<p>Close all swaglabs browser opened by this instance of the library.</p>\n<p>Example:</p>\n<table border=\"1\">\n<tr>\n<td>Close All Swaglabs Browser</td>\n</tr>\n</table>", "shortdoc": "Close all swaglabs browser opened by this instance of the library.", "tags": [], "source": "C:\\Users\\WONDERS\\Projects\\vscode\\portfolio-robotframework-custom-lib\\SwagLabsLibrary\\keywords\\BrowserKeywords.py", "lineno": 67}, {"name": "Login Error Msg Should Be", "args": [{"name": "err_msg", "types": ["str"], "typedocs": {"str": "string"}, "defaultValue": null, "kind": "POSITIONAL_OR_NAMED", "required": true, "repr": "err_msg: str"}], "doc": "<p>Validates that the displayed error message in the login page match <code>err_msg</code>.</p>\n<p>Arguments:</p>\n<ul>\n<li><code>err_msg</code>: The exepcted error message.</li>\n</ul>\n<p>Example:</p>\n<table border=\"1\">\n<tr>\n<td>Login Error Msg Should Be</td>\n<td>err_msg=Username is required.</td>\n</tr>\n</table>", "shortdoc": "Validates that the displayed error message in the login page match ``err_msg``.", "tags": ["AssertionKeywords", "LoginKeywords"], "source": "C:\\Users\\WONDERS\\Projects\\vscode\\portfolio-robotframework-custom-lib\\SwagLabsLibrary\\keywords\\LoginKeywords.py", "lineno": 56}, {"name": "Login To Swaglabs", "args": [{"name": "username", "types": ["str"], "typedocs": {"str": "string"}, "defaultValue": "None", "kind": "POSITIONAL_OR_NAMED", "required": false, "repr": "username: str = None"}, {"name": "password", "types": ["str"], "typedocs": {"str": "string"}, "defaultValue": "None", "kind": "POSITIONAL_OR_NAMED", "required": false, "repr": "password: str = None"}], "doc": "<p>Login to Swaglabs using the provided <code>username</code> and <code>password</code>. This will click the login button even when no <code>username</code> and/or <code>password</code> were provided.</p>\n<p>Arguments:</p>\n<ul>\n<li><code>username</code>: Username to use for login.</li>\n<li><code>password</code>: Password to use for login.</li>\n</ul>\n<p>Example:</p>\n<table border=\"1\">\n<tr>\n<td>Login To SwagLabs</td>\n<td>username=standard_user</td>\n<td>password=secret_sauce</td>\n</tr>\n</table>", "shortdoc": "Login to Swaglabs using the provided ``username`` and ``password``. This will click the login button even when no ``username`` and/or ``password`` were provided.", "tags": ["LoginKeywords"], "source": "C:\\Users\\WONDERS\\Projects\\vscode\\portfolio-robotframework-custom-lib\\SwagLabsLibrary\\keywords\\LoginKeywords.py", "lineno": 35}, {"name": "Logout From Swaglabs", "args": [], "doc": "<p>Logout from swaglabs.</p>\n<p>Example:</p>\n<table border=\"1\">\n<tr>\n<td>Logout from swaglabs</td>\n</tr>\n</table>", "shortdoc": "Logout from swaglabs.", "tags": [], "source": "C:\\Users\\WONDERS\\Projects\\vscode\\portfolio-robotframework-custom-lib\\SwagLabsLibrary\\keywords\\MenuKeywords.py", "lineno": 20}, {"name": "Menu Items Should Have", "args": [{"name": "args", "types": [], "typedocs": {}, "defaultValue": null, "kind": "VAR_POSITIONAL", "required": false, "repr": "*args"}], "doc": "<p>Validates that <code>args</code> are displayed in the menu.</p>\n<p>Arguments:</p>\n<ul>\n<li><code>args</code>: The expected items that should be displayed in the menu.</li>\n</ul>\n<p>Example:</p>\n<table border=\"1\">\n<tr>\n<td>Menu Items Should Have</td>\n<td>About Logout Reset${SPACE}App${SPACE}State</td>\n</tr>\n</table>", "shortdoc": "Validates that ``args`` are displayed in the menu.", "tags": [], "source": "C:\\Users\\WONDERS\\Projects\\vscode\\portfolio-robotframework-custom-lib\\SwagLabsLibrary\\keywords\\MenuKeywords.py", "lineno": 30}, {"name": "Open Swaglabs In Browser", "args": [{"name": "is_headless", "types": ["bool"], "typedocs": {"bool": "boolean"}, "defaultValue": "None", "kind": "POSITIONAL_OR_NAMED", "required": false, "repr": "is_headless: bool = None"}, {"name": "browser", "types": ["str"], "typedocs": {"str": "string"}, "defaultValue": "chrome", "kind": "POSITIONAL_OR_NAMED", "required": false, "repr": "browser: str = chrome"}], "doc": "<p>Opens the Swaglabs website in a browser.</p>\n<p>Arguments:</p>\n<ul>\n<li><code>is_headless</code>: Whether to run the browser in headless mode. If None, will follow the configuration set when <a href=\"#Importing\" class=\"name\">Importing</a> the library.</li>\n<li><code>browser</code>: The browser to use. Defaults to 'chrome'.</li>\n</ul>\n<p>Example:</p>\n<table border=\"1\">\n<tr>\n<td>Open Swaglabs in Browser</td>\n<td>is_headless=${True}</td>\n<td>browser=firefox</td>\n</tr>\n</table>", "shortdoc": "Opens the Swaglabs website in a browser.", "tags": ["BrowserKeywords"], "source": "C:\\Users\\WONDERS\\Projects\\vscode\\portfolio-robotframework-custom-lib\\SwagLabsLibrary\\keywords\\BrowserKeywords.py", "lineno": 42}, {"name": "Reload Swaglabs Browser", "args": [], "doc": "<p>Reload current page.</p>\n<p>Example:</p>\n<table border=\"1\">\n<tr>\n<td>Reload Swaglabs Browser</td>\n</tr>\n</table>", "shortdoc": "Reload current page.", "tags": [], "source": "C:\\Users\\WONDERS\\Projects\\vscode\\portfolio-robotframework-custom-lib\\SwagLabsLibrary\\keywords\\BrowserKeywords.py", "lineno": 76}, {"name": "Wait Until Login Page Is Visible", "args": [{"name": "timeout", "types": ["Any"], "typedocs": {}, "defaultValue": "None", "kind": "POSITIONAL_OR_NAMED", "required": false, "repr": "timeout: Any = None"}], "doc": "<p>Wait until login page is visible.</p>\n<p>Arguments:</p>\n<ul>\n<li><code>timeout</code>: Specific maximum time to wait before raising an exception if not visible. Defaults to None.</li>\n</ul>\n<p>Example:</p>\n<table border=\"1\">\n<tr>\n<td>Wait Until Login Page Is Visible</td>\n<td>timeout=5s</td>\n</tr>\n<tr>\n<td>Wait Until Login Page Is Visible</td>\n<td></td>\n</tr>\n</table>", "shortdoc": "Wait until login page is visible.", "tags": ["LoginKeywords"], "source": "C:\\Users\\WONDERS\\Projects\\vscode\\portfolio-robotframework-custom-lib\\SwagLabsLibrary\\keywords\\LoginKeywords.py", "lineno": 19}, {"name": "Wait Until Products Page Is Visible", "args": [{"name": "timeout", "types": ["Any"], "typedocs": {}, "defaultValue": "None", "kind": "POSITIONAL_OR_NAMED", "required": false, "repr": "timeout: Any = None"}], "doc": "<p>Wait until product page is visible.</p>\n<p>Arguments:</p>\n<ul>\n<li><code>timeout</code>: Specific maximum time to wait before raising an exception if not visible. Defaults to None.</li>\n</ul>\n<p>Example:</p>\n<table border=\"1\">\n<tr>\n<td>Wait Until Products Page Is Visible</td>\n<td>timeout=5s</td>\n</tr>\n<tr>\n<td>Wait Until Products Page Is Visible</td>\n<td></td>\n</tr>\n</table>", "shortdoc": "Wait until product page is visible.", "tags": ["ProductsKeywords"], "source": "C:\\Users\\WONDERS\\Projects\\vscode\\portfolio-robotframework-custom-lib\\SwagLabsLibrary\\keywords\\ProductsKeywords.py", "lineno": 17}], "dataTypes": {"enums": [], "typedDicts": []}, "typedocs": [{"type": "Standard", "name": "boolean", "doc": "<p>Strings <code>TRUE</code>, <code>YES</code>, <code>ON</code> and <code>1</code> are converted to Boolean <code>True</code>, the empty string as well as strings <code>FALSE</code>, <code>NO</code>, <code>OFF</code> and <code>0</code> are converted to Boolean <code>False</code>, and the string <code>NONE</code> is converted to the Python <code>None</code> object. Other strings and other accepted values are passed as-is, allowing keywords to handle them specially if needed. All string comparisons are case-insensitive.</p>\n<p>Examples: <code>TRUE</code> (converted to <code>True</code>), <code>off</code> (converted to <code>False</code>), <code>example</code> (used as-is)</p>", "usages": ["__init__", "Open Swaglabs In Browser"], "accepts": ["string", "integer", "float", "None"]}, {"type": "Standard", "name": "string", "doc": "<p>All arguments are converted to Unicode strings.</p>", "usages": ["__init__", "Login Error Msg Should Be", "Login To Swaglabs", "Open Swaglabs In Browser"], "accepts": ["Any"]}]}
</script>
<title></title>
</head>
<body>
